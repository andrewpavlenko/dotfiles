...
beautiful.init(os.getenv("AWESOME_HOME") .. "/theme.lua")
...
root.buttons(gears.table.join(
    awful.button({ }, 2, exit_screen_show),
...
globalkeys = gears.table.join(
    ...
    -- Exit screen
    awful.key({ modkey }, "q", exit_screen_show,
              {description = "show exit screen", group = "awesome"}),
    -- Volume keys
    awful.key({}, "#123", volume.volume_up,
              {description = "volume up", group = "audio"}),
    awful.key({}, "#122", volume.volume_down,
